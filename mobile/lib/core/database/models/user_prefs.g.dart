...
UserPrefs _userPrefsDeserialize(
  ...
  final object = UserPrefs(
    ...
    languageCode: reader.readStringOrNull(offsets[1]) ?? 'fr',
...
extension UserPrefsQueryFilter
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterFilterCondition> userIdEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterFilterCondition> userIdGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterFilterCondition> userIdLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterFilterCondition> userIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterFilterCondition> userIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterFilterCondition> userIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterFilterCondition> userIdContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterFilterCondition> userIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterFilterCondition> userIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'userId',
        value: '',
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterFilterCondition> userIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'userId',
        value: '',
...
extension UserPrefsQuerySortBy on QueryBuilder<UserPrefs, UserPrefs, QSortBy> {
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterSortBy> sortByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<UserPrefs, UserPrefs, QAfterSortBy> sortByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserPrefsQuerySortThenBy
  ...
  QueryBuilder<UserPrefs, UserPrefs, QAfterSortBy> thenByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<UserPrefs, UserPrefs, QAfterSortBy> thenByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.desc);
    });
  }
...
extension UserPrefsQueryWhereDistinct
  ...
  QueryBuilder<UserPrefs, UserPrefs, QDistinct> distinctByUserId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserPrefsQueryProperty
  ...
  QueryBuilder<UserPrefs, String, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
