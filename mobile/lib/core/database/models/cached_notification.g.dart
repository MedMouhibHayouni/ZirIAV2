...
part of 'cached_notification.dart';
...
CachedNotification _cachedNotificationDeserialize(
  ...
  final object = CachedNotification(
    ...
    isRead: reader.readBool(offsets[2]),
...
void _cachedNotificationAttach(
    IsarCollection<dynamic> col, Id id, CachedNotification object) {
  object.id = id;
}

extension CachedNotificationByIndex on IsarCollection<CachedNotification> {
  Future<CachedNotification?> getByRemoteId(String remoteId) {
    return getByIndex(r'remoteId', [remoteId]);
  }

  CachedNotification? getByRemoteIdSync(String remoteId) {
  ...
  Future<List<CachedNotification?>> getAllByRemoteId(
      List<String> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'remoteId', values);
  }

  List<CachedNotification?> getAllByRemoteIdSync(List<String> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByRemoteId(CachedNotification object) {
    return putByIndex(r'remoteId', object);
  }

  Id putByRemoteIdSync(CachedNotification object, {bool saveLinks = true}) {
    return putByIndexSync(r'remoteId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByRemoteId(List<CachedNotification> objects) {
    return putAllByIndex(r'remoteId', objects);
  }

  List<Id> putAllByRemoteIdSync(List<CachedNotification> objects,
      {bool saveLinks = true}) {
...
extension CachedNotificationQueryWhereSort
  ...
  QueryBuilder<CachedNotification, CachedNotification, QAfterWhere> anyId() {
...
extension CachedNotificationQueryProperty
  ...
  QueryBuilder<CachedNotification, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
