...
extension GetFinanceSummaryCollection on Isar {
  IsarCollection<FinanceSummary> get financeSummarys => this.collection();
}

const FinanceSummarySchema = CollectionSchema(
  name: r'FinanceSummary',
  id: 8108373929981580330,
  properties: {
  ...
  estimateSize: _financeSummaryEstimateSize,
  serialize: _financeSummarySerialize,
  deserialize: _financeSummaryDeserialize,
  deserializeProp: _financeSummaryDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},
  getId: _financeSummaryGetId,
  getLinks: _financeSummaryGetLinks,
  attach: _financeSummaryAttach,
  version: '3.1.0+1',
);

int _financeSummaryEstimateSize(
...
void _financeSummarySerialize(
  ...
  writer.writeDouble(offsets[3], object.totalRevenue);
}

FinanceSummary _financeSummaryDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = FinanceSummary();
  ...
  object.totalRevenue = reader.readDouble(offsets[3]);
  return object;
}

P _financeSummaryDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _financeSummaryGetId(FinanceSummary object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _financeSummaryGetLinks(FinanceSummary object) {
  return [];
}

void _financeSummaryAttach(
    IsarCollection<dynamic> col, Id id, FinanceSummary object) {
  object.id = id;
}

extension FinanceSummaryQueryWhereSort
    on QueryBuilder<FinanceSummary, FinanceSummary, QWhere> {
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterWhere> anyId() {
...
extension FinanceSummaryQueryWhere
    on QueryBuilder<FinanceSummary, FinanceSummary, QWhereClause> {
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterWhereClause> idEqualTo(
      Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterWhereClause> idNotEqualTo(
      Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterWhereClause> idGreaterThan(
      Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterWhereClause> idLessThan(
      Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension FinanceSummaryQueryFilter
    on QueryBuilder<FinanceSummary, FinanceSummary, QFilterCondition> {
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterFilterCondition>
      balanceEqualTo(
    double value, {
  ...
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterFilterCondition> idEqualTo(
      Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
  ...
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterFilterCondition> idBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension FinanceSummaryQueryObject
    on QueryBuilder<FinanceSummary, FinanceSummary, QFilterCondition> {}

extension FinanceSummaryQueryLinks
    on QueryBuilder<FinanceSummary, FinanceSummary, QFilterCondition> {}

extension FinanceSummaryQuerySortBy
    on QueryBuilder<FinanceSummary, FinanceSummary, QSortBy> {
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterSortBy> sortByBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.asc);
    });
  }

  QueryBuilder<FinanceSummary, FinanceSummary, QAfterSortBy>
      sortByBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FinanceSummaryQuerySortThenBy
    on QueryBuilder<FinanceSummary, FinanceSummary, QSortThenBy> {
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterSortBy> thenByBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.asc);
    });
  }
  ...
  QueryBuilder<FinanceSummary, FinanceSummary, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<FinanceSummary, FinanceSummary, QAfterSortBy> thenByIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FinanceSummaryQueryWhereDistinct
    on QueryBuilder<FinanceSummary, FinanceSummary, QDistinct> {
  QueryBuilder<FinanceSummary, FinanceSummary, QDistinct> distinctByBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'balance');
    });
  }

  QueryBuilder<FinanceSummary, FinanceSummary, QDistinct>
...
extension FinanceSummaryQueryProperty
    on QueryBuilder<FinanceSummary, FinanceSummary, QQueryProperty> {
  QueryBuilder<FinanceSummary, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<FinanceSummary, double, QQueryOperations> balanceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'balance');
    });
  }

  QueryBuilder<FinanceSummary, DateTime, QQueryOperations>
      lastUpdatedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FinanceSummary, double, QQueryOperations>
...
extension InventoryItemQuerySortBy
  ...
  QueryBuilder<InventoryItem, InventoryItem, QAfterSortBy> sortByRemoteId() {
    return QueryBuilder.apply(this, (query) {
...
extension InventoryItemQuerySortThenBy
  ...
  QueryBuilder<InventoryItem, InventoryItem, QAfterSortBy> thenByRemoteId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'remoteId', Sort.asc);
    });
  }
...
extension InventoryItemQueryWhereDistinct
  ...
  QueryBuilder<InventoryItem, InventoryItem, QDistinct> distinctByRemoteId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension InventoryItemQueryProperty
  ...
  QueryBuilder<InventoryItem, String, QQueryOperations> remoteIdProperty() {
    return QueryBuilder.apply(this, (query) {
...
String _$financeRepositoryHash() => r'09ad50595e281418f890d1a496fd3160051b07ef';
